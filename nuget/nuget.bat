...
REM nuget push "c:\temp\modules\Transformalize.Provider.Solr.0.6.12-beta.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget push "c:\temp\modules\Transformalize.Provider.Solr.Autofac.0.6.12-beta.nupkg" -source https://api.nuget.org/v3/index.json
